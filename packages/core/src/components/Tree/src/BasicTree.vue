<script lang="tsx">
  ...
  import { isArray, isBoolean, isEmpty, isFunction } from '@fer-codeless/utils';
  import { extendSlots, getSlot } from '@fer-codeless/utils';
  import { filter, treeToList, eachTree } from './helper/treeHelper';
  import { useTree } from './hooks/useTree';
  import { useContextMenu } from '@/hooks/web/useContextMenu';
  import { treeEmits, treeProps } from './types/tree';
  import { createBEM } from '@fer-codeless/utils';
        ...
        return (
          <div class={[bem(), 'h-full', attrs.class]}>
            ...
            <Spin wrapperClassName={unref(props.treeWrapperClassName)} spinning={unref(props.loading)} tip="加载中...">
              ...
              <a-empty v-show={unref(getNotFound)} />
            </Spin>
          </div>
        );
      };
