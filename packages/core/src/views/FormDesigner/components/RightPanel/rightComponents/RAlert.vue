<template>
  <a-form-item label="提示文本">
    <fer-input v-model:value="activeData.title" placeholder="请输入" />
  </a-form-item>
  <a-form-item label="辅助文本">
    <fer-input v-model:value="activeData.description" placeholder="请输入" />
  </a-form-item>
  ...
  <a-form-item label="按钮文字" v-if="activeData.closable">
    <fer-input v-model:value="activeData.closeText" :maxlength="10" placeholder="请输入" />
  </a-form-item>
</template>
